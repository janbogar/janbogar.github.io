...
kde $$k$$ je počet škál na ktoré vesmír delíme, tzn. $$k=1+\log_N{\frac{m_{max}}{m_{min}}}$$. Po troche algebry {% include collapsible.html content= "súčet konečného geometrického radu $$1+N+N^2 \dots N^{k-1}=\frac{N^k-1}{N-1}$$ a fakt, že $$N^{k-1}=\frac{m_{max}}{m_{min}}$$"%} a pár zanedbaniach {% include collapsible.html content= "$$N^{k}-1 \approx N^{k} a \frac{N-1}{N} \approx 1$$, "%} dostaneme tento vzťah v nádhernej forme:
